...
Provider submodules keep their own tags (`providers/aws/v0.1.0`, `x/otel/v0.1.0`, `x/prom/v0.1.0`, ...) and are released separately, so a breaking change in one SDK never forces a core release.
