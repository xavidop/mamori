...
The error-classification sweep is complete: every one of the 37 providers now falls into exactly one of three honest states, and `not_found` itself is detected by every provider regardless of which one.
