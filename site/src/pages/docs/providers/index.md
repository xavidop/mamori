...
- **✅** - classifies real backend errors beyond `not_found`: thirty-five providers across thirty modules (the `env:` / `dotenv://` / `file://` / `exec:` rows are one core module, counted as four providers).
