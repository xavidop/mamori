...
- **✅** - classifies real backend errors beyond `not_found`: thirty-seven providers across thirty-two modules (the `env:` / `dotenv://` / `file://` / `exec:` rows are one core module, counted as four providers).
