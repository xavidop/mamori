...
- **✅** - classifies real backend errors beyond `not_found`: thirty-eight providers across thirty-three modules (the `env:` / `dotenv://` / `file://` / `exec:` rows are one core module, counted as four providers).
