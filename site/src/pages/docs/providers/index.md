...
- **✅** - classifies real backend errors beyond `not_found`: thirty-four providers across twenty-nine modules (the `env:` / `dotenv://` / `file://` / `exec:` rows are one core module, counted as four providers).
