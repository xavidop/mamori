...
// only to type-check the cmd/mamori vet test fixture. It defines String and
// Bytes as named struct types (distinct from plain string/[]byte) so the
// mamori vet analyzer sees a redacting wrapper, not a plain type, without
// pulling the real core module into this fixture's dependency graph.
package secret
